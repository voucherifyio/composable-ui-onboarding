...
export const NEXT_PUBLIC_CONTENTFUL_ONLY_PUBLISHED_API_KEY =
  process.env.NEXT_PUBLIC_CONTENTFUL_ONLY_PUBLISHED_API_KEY
export const NEXT_PUBLIC_CONTENTFUL_SPACE_ID =
  process.env.NEXT_PUBLIC_CONTENTFUL_SPACE_ID

export const NEXT_PUBLIC_MAX_NUMBER_OF_COUPONS: number = isNaN(
